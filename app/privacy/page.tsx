  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <div className="space-y-6 text-sm leading-7 text-gray-700 dark:text-gray-300">
        <p>
          スマホクラーベ（以下、「当サイト」といいます。）は、当サイトにおける利用者情報の取扱いについて、以下のとおりプライバシーポリシーを定めます。
        </p>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>アクセス日時</li>
            <li>閲覧したページ</li>
            <li>利用端末やブラウザに関する情報</li>
            <li>IPアドレス</li>
            <li>参照元情報</li>
            <li>広告配信やアクセス解析に必要な識別情報</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>利用状況の分析のため</li>
            <li>不正利用の防止やセキュリティ確保のため</li>
            <li>利用者に適した広告を表示するため</li>
            <li>広告配信の効果測定のため</li>
            <li>お問い合わせ対応のため</li>
          </ul>
        </section>
